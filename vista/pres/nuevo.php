...
<?php
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li class="active"><a href="mostrar.php">Listado de Préstamos</a></li>
				  <li>Nuevo Préstamos</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-padding" method="post" action="registro2.php"  autocomplete="off">
				
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<span>Nombre del libro</span>
						<select class="material-control tooltips-general" id="libro" name="codlibro" data-toggle="tooltip" data-placement="top" title="Elige el libro">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<span>Nombre del estudiante</span>
						<select class="material-control tooltips-general" id="estudiante" name="codalum" data-toggle="tooltip" data-placement="top" title="Elige el estudiante">
			...
			<div class="col-xs-6 col-sm-6">
				<div class="group-material">
					<span>Stock de libros</span>
						<select class="material-control tooltips-general " readonly="" id="canti"  data-toggle="tooltip" data-placement="top" title="Elige el estudiante">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="date" value="<?php echo date("Y-m-d");?>" class="material-control tooltips-general" name="finicio" placeholder="Ingrese fecha de ingreso" required=""  data-toggle="tooltip" data-placement="top" title="Escribe la fecha">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="date" value="<?php echo date("Y-m-d");?>" class="material-control tooltips-general" name="ffinal" placeholder="Ingrese fecha de ingreso" required=""  data-toggle="tooltip" data-placement="top" title="Escribe la fecha">
					<span class="highlight"></span>
					<span class="bar"></span>
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="can" placeholder="Ingrese la cantidad" required="" maxlength="2"  data-toggle="tooltip" data-placement="top" title="Escribe la cantidad" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
					<span class="highlight"></span>
					<span class="bar"></span>
  ...
  <script src="../../assets/js/funciones/functions9.js"></script>
  <script src="../../assets/js/funciones/functions10.js"></script>
