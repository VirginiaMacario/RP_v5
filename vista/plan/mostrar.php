        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
					...
					<li><a href="libro.php"><i class="zmdi zmdi-dns zmdi-hc-fw"></i>&nbsp;&nbsp; Salones</a></li>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar un nuevo archivo de estudio, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li class="active">Listado archivos</li>
				  <li><a href="../vista/plan/nuevo2.php">Nuevo archivos</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">Listado archivos</h2>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar plan" aria-label="Plan" aria-describedby="basic-addon1">
		</div>
             ...
             <table class="table table-striped">
                        ...
                        <tbody class="BusquedaRapida">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr>
                              <td><?php echo $va['codplane'];?></td>

                              <td><?php echo $va ['titu'];?></td>
                              <td><?php echo $va ['descrp'];?></td>
							  <td><?php echo $va ['nomclase'];?></td>
							  <td><?php echo $va ['archi'];?></td>
							<td></td>
								...
								<td>
								<a href="#ver_<?php echo $va["codplane"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
								
								
								
								<a href="#delete_<?php echo $va["codplane"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
							<?php include('../vista/plan/BorrarEditarModal.php'); ?>
