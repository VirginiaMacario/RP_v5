    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="row form-group">
				...
				<input type="text" class="form-control" name="tituloa" id="imagen" placeholder="Nombre" value="<?php echo $va['tituloa']; ?>">
            ...
            <div class="row form-group">
				...
				<div class="col-12 col-md-9">
				<input type="date" class="form-control" name="fechaini" id="imagen" placeholder="Fecha" value="<?php echo $va['fechaini']; ?>">
				<input type="hidden" class="form-control" name="imagenactual" id="imagenactual">
                </div>
            </div>
            ...
            <div class="row form-group">
				...
				<div class="col-12 col-md-9">
				<input type="time" class="form-control" name="horaini" id="imagen" placeholder="Hora" value="<?php echo $va['horaini']; ?>">
				<input type="hidden" class="form-control" name="imagenactual" id="imagenactual">
                </div>
            </div>
            ...
            <div class="row form-group">
				...
				<div class="col-12 col-md-9">
				<input type="time" class="form-control" name="fecha_limite" id="imagen" placeholder="Hora" value="<?php echo $va['fecha_limite']; ?>">
				<input type="hidden" class="form-control" name="imagenactual" id="imagenactual">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="col-xs-12 col-sm-6">
					<div class="group-material">
						...
						<select class="material-control" name="coddoce" id="doce"  data-toggle="tooltip" data-placement="top" title="Elige el instructor" value="<?php echo $va['nomprof']; ?>">
							>
