...
<head>
  ...
  <link rel="icon" type="image/png" sizes="96x96" href="../assets/images/marianogalvez.png">
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar un nuevo grupo, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  ...
				  <li><a href="grado.php?op=nuevo">Nuevo grupo</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">Listado de grupos</h2>
                          ...
                          foreach ($dato as $key => $value){
                           ...
                           <tr>
                              ...
                              <td><?php echo $va ['fecha_create'];?></td>
								...
								<td>
								<a href="#ver_<?php echo $va["codgra"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
								
								
								
								<a href="#delete_<?php echo $va["codgra"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
								<?php include('../vista/grado/BorrarEditarModal.php'); ?>
