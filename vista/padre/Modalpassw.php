...
<div class="modal fade" id="password_<?php echo $va['codpad']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form  method="POST" autocomplete="off" action="../vista/padre/editarpassw.php?id=<?php echo $va['codpad']; ?>">
