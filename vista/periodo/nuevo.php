		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation"><a href="../calendario/mostrar.php">Calendario</a></li>
			   ...
			   <li role="presentation"><a href="#">Calificaciones</a></li>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="mostrar.php">Listado de periodos</a></li>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">Nuevos de periodos</h2>

	                <form class="form-padding" method="post" action="recibir.php">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos del periodo</legend><br>
                        </div>
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="nompe" placeholder="Nombre del periodo" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del periodo">
					<span class="highlight"></span>
					<span class="bar"></span>
					<label>Nombre del perido</label>
				</div>
			</div>
