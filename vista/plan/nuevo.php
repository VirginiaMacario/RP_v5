		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation"><a href="../../folder/seccion.php">Secciones</a></li>
			   <li role="presentation" class="active"><a href="#">Plan </a></li>
			    <li role="presentation"><a href="../../folder/asignacion.php">Asignación</a></li>
				<li role="presentation"><a href="#">Horario</a></li>
            </ul>
        </div>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="../../assets/images/planificacion.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar un nuevo plan de estudio, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="../../folder/plan.php">Listado de plan de estudios</a></li>
				  <li class="active">Nueva plan de estudio</li>
				</ol>
			</div>
		</div>
	</div>
	...
	if(isset($_SESSION['message'])){
		?>
		 ...
		 <div class="col-sm-12">
          ...
          <strong>Eliminado </strong> <?php echo $_SESSION['message']; ?>.
        </div> 
            </div>
	...
	if(isset($_SESSION['message'])){
		...
		unset($_SESSION['message']);
            ...
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar plan de estudio</div>
				
				
                <form class="form-padding" method="post"  action="registro.php" enctype='multipart/form-data'  autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos del plan de estudio</legend><br>
                        </div>
						
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="titu" placeholder="Nombre del plan" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre del plan">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="descrp"  placeholder="Capacidad"  required=""  data-toggle="tooltip" data-placement="top" title="Descripción">
					<span class="highlight"></span>
					<span class="bar"></span>
			...
			<div class="group-material">
				<span>Clase</span>
				<select class="material-control" name="cboclase" id="clas" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige la clase">
...
<!--------- FUNCIONES ------------------------->
	 <script src="../../assets/js/funciones/functions6.js"></script>
