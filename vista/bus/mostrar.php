	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li class="active">Listado de buses</li>
				  <li><a href="nuevo.php">Nuevos buses</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">listado de buses</h2>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar buses..." aria-label="Grado" aria-describedby="basic-addon1">
		</div>
			...
			try{	
				...
				foreach ($db->query($sql) as $row) {
					...
					?>
					<tr>
						<td><?php echo $row['codbus']; ?></td>
						<td><?php echo $row['dnicon']; ?></td>
						
						<td><?php echo $row['nombrcon']; ?> <br> <?php echo $row['apecon']; ?> </td>
						<td><?php echo $row['direcc']; ?><br> <?php echo $row['celular']; ?> <br> <?php echo $row['fijo']; ?> </td>
						
						<td><?php echo $row['placa']; ?></td>
						
						<td><?php  echo "<img src='../../assets/images/imagenes/".$row['imagen']."'width='90'"; ?></td>
					<!-- ------------------------------------------>
					
						<td>
						
							
							<a href="#ver_<?php echo $row["codbus"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
								
								
								
								<a href="#delete_<?php echo $row["codbus"]; ?>"  title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
