    ...
    <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation" class="active"><a href="#">Tema</a></li>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="../assets/images/pizarra.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar nuevos temas, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  ...
				  <li><a href="tema.php?op=nuevo">Nuevos temas</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar tema" aria-label="Tema" aria-describedby="basic-addon1">
		</div>
             ...
             <table class="table table-striped">
                        ...
                        <tbody class="BusquedaRapida">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr>
                              <td><?php echo $va['codtem'];?></td>

                              <td><?php echo $va ['nomtema'];?></td>
							  ...
							  <td><?php echo $va ['nomprof'];?></td>
								...
								<td>
								<a href="#ver_<?php echo $va["codtem"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
								
								
								
								<a href="#delete_<?php echo $va["codtem"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
							<?php include('../vista/tema/BorrarEditarModal.php'); ?>
