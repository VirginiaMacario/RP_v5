...
<div class="modal fade" id="edit_<?php echo $row['codasis']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="../vista/asisalum/BorrarRegistro.php?id=<?php echo $row['codasis']; ?>">
