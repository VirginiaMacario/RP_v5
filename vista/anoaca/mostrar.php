    ...
    <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation" class="active"><a href="#">Año académico</a></li>
              <li role="presentation"><a href="../vista/bus/mostrar.php">Bus escolar</a></li>
			   <li role="presentation"><a href="../vista/conge/mostrar.php">Configuración general</a></li>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar un nuevo año, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li class="active">Listado de años académicos</li>
				  <li><a href="anoaca.php?op=nuevo">Nuevo años académicos</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">listado de años académicos</h2>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Buscar año..." aria-label="Grado" aria-describedby="basic-addon1">
		</div>
             ...
             <table class="table table-striped">
                        ...
                        <tbody class="BusquedaRapida">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr>
                              <td><?php echo $va['codano'];?></td>


                              	

                              <td><?php echo $va ['nomano'];?></td>
							  <td><?php echo $va ['titulo'];?></td>
                              <td><?php echo $va ['fecha_registro'];?></td>
                              



								<td>
								<a href="#ver_<?php echo $va["codano"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
								
								
								
								<a href="#delete_<?php echo $va["codano"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
								<?php include('../vista/anoaca/BorrarEditarModal.php'); ?>
