...
<?php
            ...
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation"><a href="../../folder/seccion.php">Secciones</a></li>
			   <li role="presentation" class="active"><a href="#">Plan </a></li>
			    <li role="presentation"><a href="#">Asignación</a></li>
		...
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  ...
				  <li class="active">Nuevo plan de estudio</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar un nuevo plan de estudio</div>
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="descrp"  placeholder="Descripción"  required=""  data-toggle="tooltip" data-placement="top" title="Descripción">
					<span class="highlight"></span>
					<span class="bar"></span>
			...
			<div class="group-material">
				<span>Clase</span>
				<select class="material-control" name="codclase" id="clas" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige la clase">
