    ...
    <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
			  ...
			  <li role="presentation"><a href="../vista/pres/mostrar.php">Préstamos</a></li>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li class="active">Listado de libro</li>
				  <li><a href="../vista/libro/nuevo.php">Nuevo libro</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">Catálogo de libros</h2>
         ...
         <div class="container-fluid">
		  ...
		  foreach ($dato as $key => $value){
			  foreach ($value as $va) { ?>
		   <tr>
			  <td><?php echo $va['codlibro'];?></td>

			<td><?php  echo "<img src='../assets/images/imagenes/".$va['foto']."'width='90'"; ?></td>
				

			 
			  <td><?php echo $va ['titu'];?> <br> <i class="zmdi zmdi-face"></i></td>
			  
			  <td><?php echo $va ['anopu'];?> <br> </td>
			  
			  <td><?php echo $va ['aut'];?> <br> </td>
			  <td>
             <?php    if($va['esta']=='Disponible')  { ?> 
              <form  method="get" action="javascript:activo('<?php echo $va['codlibro']; ?>')">
                <button type="submit" class="btn btn-success btn-xs">Disponible</button>
              </form>
            <?php  }   else {?> 

              <form  method="get" action="javascript:inactivo('<?php echo $va['codlibro']; ?>')"> 
                <button type="submit" class="btn btn-danger btn-xs">No disponible</button>
              </form>
            <?php  } ?>                         
          </td>
		  
		  <td>
		  <a class="btn" href="../../assets/images/imagenes/<?php echo $va['archi']; ?>" download="<?php echo $va['archi']; ?>"><span class="glyphicon glyphicon-download-alt" aria-hidden="true">
	  </span> </a>
			...
			<td>
			<a href="#ver_<?php echo $va["codlibro"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
			
			
			
			<a href="#delete_<?php echo $va["codlibro"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
			<?php include('../vista/libro/BorrarEditarModal.php'); ?>
