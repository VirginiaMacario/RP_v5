    ...
    <div class="content-page-container full-reset custom-scroll-containers">
		...
		<div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              ...
              <li role="presentation"><a href="../bus/mostrar.php">Bus escolar</a></li>
               <li role="presentation" class="active"><a>Configuración general</a></li>
            </ul>
        </div>
		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="../../assets/images/confige.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección de la configuración del sistema.
                </div>
            </div>
        </div>
...
?>
<a id="addnewbtn" style="display:none;" data-target="#userModal" title="Mostrar" data-backdrop="false"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span></a>
<?php include('nuevoModal.php'); ?>

	<div class="container-fluid">
            <h2 class="text-center all-tittles">Ajustes del sistema</h2>
			...
			$db = $database->open();
			try{	
				$sql = 'SELECT * FROM configge';
				foreach ($db->query($sql) as $row) {
		
					?>
					<tr>
						<td><?php echo $row['codconf']; ?></td>
						<td><?php echo $row['nombc']; ?></td>
						
						
						<td><?php echo $row['email']; ?><br> <?php echo $row['sitio']; ?> <br> <?php echo $row['telefo']; ?> </td>
					...
					<!-- ------------------------------------------>
						...
						<td>
							...
							<a href="#ver_<?php echo $row["codconf"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
								
								
								
								<a href="#delete_<?php echo $row["codconf"]; ?>"  title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
