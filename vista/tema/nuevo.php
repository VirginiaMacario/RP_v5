...
<?php
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="tema.php">Listado de temas</a></li>
				  <li class="active">Nuevos temas</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar temas</div>
				
				
                <form class="form-padding" method="post" action="?op=recibir" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos del tema</legend><br>
                        </div>
						
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txtnomtema" placeholder="Nombre del tema" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre del tema">
			...
			<div class="group-material">
				<span>Clase</span>
				<select class="material-control" name="cboclase" id="class" tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el grupo">
					<option value=""  selected="">Selecciona el tema</option>
