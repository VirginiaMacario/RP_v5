		 ...
		 <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar un nuevo tema, debes de llenar todos los campos del siguiente formulario para poder registrarlo.
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  ...
				  <li><a href="clase.php?op=nuevo">Nuevo tema</a></li>
				</ol>
			</div>
		</div>
	</div>
...
?>
	...
	<div class="container-fluid">
            <h2 class="text-center all-tittles">Listado de temas</h2>
		  ...
		  <input id="FiltrarContenido" type="text" class="form-control" placeholder="Ingrese tema" aria-label="Grado" aria-describedby="basic-addon1">
		</div>
		<button onclick="window.location.href='reporteclase.php'" tooltips-general="PDF" type="button" class="btn btn-secundary" style="margin-top:-60px; margin-left:1000px;"><i class="zmdi zmdi-print zmdi-hc-fw"></i>&nbsp;&nbsp; PDF</button>
		<button onclick="window.location.href='excelclase.php'" tooltips-general="EXCEL" type="button" class="btn btn-secundary" style="margin-top:-105px; margin-left:1070px;"><i class="zmdi zmdi-print zmdi-hc-fw"></i>&nbsp;&nbsp; EXCEL</button>
             ...
             <table class="table table-striped">
                        ...
                        <tbody class="BusquedaRapida">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr>
                              <td><?php echo $va['codclase'];?></td>
                              <!--<td><?php echo $va ['nomano'];?></td>-->
                              <td><?php echo $va ['nomclase'];?></td>
							  <td><?php echo $va ['info'];?></td>
							  <!--<td><?php echo $va ['nomgra'];?></td>
							  <td><?php echo $va ['tipo'];?></td>-->
                              



								<td>
								<a href="#ver_<?php echo $va["codclase"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
								
								
								
								<a href="#delete_<?php echo $va["codclase"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
							<?php include('../vista/clase/BorrarEditarModal.php'); ?>

							<a href="#file_<?php echo $va["codclase"]; ?>" title="Editar" data-backdrop="false" class="btn btn-success btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-picture"></span></a>
								<?php include('../vista/clase/EditarModal.php'); ?>
