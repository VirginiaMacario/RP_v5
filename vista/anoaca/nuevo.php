...
<?php
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 lead">
				<ol class="breadcrumb">
				  <li><a href="../folder/anoaca.php">Listado de años académicos</a></li>
				  <li class="active">Nuevo años académicos</li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar un nuevo año académico</div>
				
				
                <form class="form-padding" method="post" action="?op=recibir" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12">
                            <legend><i class="zmdi zmdi-flower"></i> &nbsp; Datos del año académico</legend><br>
                        </div>
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txtnomanio" placeholder="Nombre del año académico" required="" maxlength="4" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del año académico">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="group-material">
					<input type="text" class="material-control tooltips-general" name="txttitul" placeholder="Nombre del año académico" required=""  data-toggle="tooltip" data-placement="top" title="Escribe el nombre del año académico">
					<span class="highlight"></span>
					<span class="bar"></span>
					<label>Título</label>
				</div>
